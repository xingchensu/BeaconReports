...
SET ANSI_NULLS ON
GO
CREATE PROC [dbo].[Keystats_AuditorActivity_Companystats_Load]  
    (  
      @BEGINDATE DATETIME ,  
      @ENDDATE DATETIME            
    )  
AS  
    BEGIN            
        ...
        SELECT  [index] ,  
                ...
                ISNULL(startdateminute,0) startdateminute ,  
                ISNULL(enddateminute,0) enddateminute  
        ...
        SELECT  5 [index] ,  
                ...
                ( CurrentSpan.genTotalHours - PreviousSpan.genTotalHours ) genTotalHours ,  
                ( CurrentSpan.genExpectedHours - PreviousSpan.genExpectedHours ) genExpectedHours ,  
                ( CurrentSpan.genTotalPay - PreviousSpan.genTotalPay ) genTotalPay ,  
                ( CurrentSpan.genAvgPayPerHour - PreviousSpan.genAvgPayPerHour ) genAvgPayPerHour ,  
                ( CurrentSpan.destotalHours - PreviousSpan.destotalHours ) destotalHours ,  
                ( CurrentSpan.desTotalDesigns - PreviousSpan.desTotalDesigns ) desTotalDesigns ,  
                ...
                ( CurrentSpan.desCharPerHour - PreviousSpan.desCharPerHour ) desCharPerHour ,  
                ( CurrentSpan.desCostPerDesign - PreviousSpan.desCostPerDesign ) desCostPerDesign ,  
                ( CurrentSpan.keyTotalHours - PreviousSpan.keyTotalHours ) keyTotalHours ,  
                ...
                ( CurrentSpan.keyCostPerDesign - PreviousSpan.keyCostPerDesign ) keyCostPerDesign ,  
                ( CurrentSpan.less20TotalHours - PreviousSpan.less20TotalHours ) less20TotalHours ,  
                ...
                - PreviousSpan.startdateminute AS VARCHAR(10)) + ' min' dailyStart ,  
                CAST(CurrentSpan.enddateminute - PreviousSpan.enddateminute AS VARCHAR(10))  
                + ' min' dailyEnd ,  
                ( CurrentSpan.totalActiveHours - PreviousSpan.totalActiveHours ) totalActiveHours ,  
                ( CurrentSpan.nonWorkHours - PreviousSpan.nonWorkHours ) nonWorkHours ,  
                ( CurrentSpan.keyStroke - PreviousSpan.keyStroke ) keyStroke ,  
                ( CurrentSpan.totalEmails - PreviousSpan.totalEmails ) totalEmails ,  
